...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("$ is the start of money"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("Today is Sunday"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("3 is my fav number"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        self.assertEqual(pythonBasics3.multiple_words(" ---- -- ++ "), True)
